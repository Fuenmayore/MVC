        ...
        <ul class="navbar-nav d-flex align-items-center navbar-light ml-auto">
            ...
            <li class="dropdown">
                <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                    ...
                    <div class="d-none d-md-block d-lg-inline-block"><h6><?php echo e(\Illuminate\Support\Facades\Auth::user()->name); ?></h6></div>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="#"><i data-feather="user"></i> Account</a>
                    <a class="dropdown-item active" href="#"><i data-feather="mail"></i>
...
</nav><?php /**PATH C:\Users\DELL\Documents\Universidad\MVC\resources\views/layouts/header.blade.php ENDPATH**/ ?>